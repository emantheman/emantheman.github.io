/**
 * This is NOT my Component. It is the work of Keyan Zhang and I snatched it from his github repo here: https://github.com/keyz/react-atv-img.
 * I did this not out of malicious intent but because there seems to be a bug running around his code, born of the so-called "advancement of 
 * modern technology"--the *cough* upgrading of React to not natively entail PropTypes. This is my attempt to take matters into my own hands.
 * 
 * -NBC
 */
import React, { Component } from 'react';

import styles from '../styles/AtvImgStyles';
